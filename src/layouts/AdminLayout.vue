...
<template>
  <div class="admin-shell">
    <aside class="admin-sidebar">
      <RouterLink class="admin-brand" to="/admin"><img src="/klovercloud-mark.svg" alt="KloverCloud" />KloverCloud</RouterLink>
...
<style scoped>
.admin-shell{display:flex;min-height:100vh;background:#f8fafc}.admin-sidebar{position:fixed;inset:0 auto 0 0;display:flex;flex-direction:column;width:15rem;padding:1.6rem 1rem;background:#111c32;color:#d8e2f0}.admin-brand{display:flex;align-items:center;gap:.55rem;padding:.45rem;color:#fff;font-size:1.35rem;font-weight:800}.admin-brand img{width:1.7rem;height:1.7rem}.admin-label{display:flex;align-items:center;gap:.45rem;margin:2rem .5rem .7rem;color:#f9a8d4;font-size:.67rem;font-weight:800;letter-spacing:.12em}.admin-nav{display:flex;align-items:center;gap:.75rem;margin:.2rem 0;padding:.75rem .85rem;border-radius:.65rem;color:#b9c8da;font-size:.88rem;font-weight:650}.admin-nav:hover,.admin-nav.active{background:#2a2945;color:#fff}.admin-nav.active{box-shadow:inset 3px 0 #ec4899}.admin-logout{display:flex;align-items:center;gap:.6rem;margin-top:auto;padding:.7rem .85rem;border:0;border-radius:.65rem;background:transparent;color:#b9c8da;font-weight:650;cursor:pointer}.admin-logout:hover{background:#243047;color:#fff}.admin-main{width:calc(100% - 15rem);margin-left:15rem}.admin-topbar{display:flex;align-items:center;justify-content:space-between;height:4.8rem;padding:0 2rem;border-bottom:1px solid #e2e8f0;background:#fff}.admin-topbar span,.admin-topbar strong{display:block}.admin-topbar span{color:#64748b;font-size:.76rem}.admin-topbar strong{margin-top:.15rem;color:#0f172a;font-size:.94rem}.admin-avatar{display:grid;place-items:center;width:2.3rem;height:2.3rem;border-radius:50%;background:#fce7f3;color:#be185d;font-size:.75rem;font-weight:800}.admin-content{padding:2rem;max-width:100rem}.dark .admin-shell{background:#0f172a}.dark .admin-topbar{border-color:#334155;background:#18233a}.dark .admin-topbar strong{color:#f8fafc}.dark .admin-topbar span{color:#b8c7dc}@media(max-width:820px){.admin-shell{display:block}.admin-sidebar{position:static;width:auto;min-height:auto;padding:.8rem 1rem;flex-flow:row wrap;align-items:center;gap:.55rem}.admin-label{display:none}.admin-sidebar nav{display:flex;order:3;width:100%;gap:.35rem;overflow-x:auto;padding-bottom:.15rem;scrollbar-width:thin}.admin-nav{flex:0 0 auto;margin:0;padding:.62rem .75rem;white-space:nowrap}.admin-nav :deep(svg){display:block}.admin-logout{display:flex;margin:0 0 0 auto;padding:.55rem}.admin-logout :deep(svg){margin:0}.admin-logout{font-size:0}.admin-logout :deep(svg){font-size:initial}.admin-main{width:100%;margin:0}.admin-topbar{height:4.1rem;padding:0 1rem}.admin-content{padding:1.2rem}}@media(max-width:440px){.admin-brand{font-size:1.12rem}.admin-topbar span{display:none}.admin-content{padding:.85rem}.admin-sidebar{padding:.7rem .85rem}}
</style>

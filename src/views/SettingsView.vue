...
<template>
  ...
  <div class="tabs"><button :class="{ active: tab === 'business' }" @click="tab = 'business'">Empresa</button><button :class="{ active: tab === 'afip' }" @click="tab = 'afip'">ARCA</button><button :class="{ active: tab === 'users' }" @click="tab = 'users'">Usuarios</button></div>
